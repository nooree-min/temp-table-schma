...
export const CardinalityZeroOrOneLeftIcon: FC<Props> = (props) => {
  return (
    <svg
      role="img"
      aria-label="Cardinality Zero or One Left"
      width={22}
      height={16}
      viewBox="0 0 22 16"
      fill="none"
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
      />
      <path d="M22 7.7002H11V8.7002H22V7.7002Z" fill="currentColor" />
    </svg>
  )
}
